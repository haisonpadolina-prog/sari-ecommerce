...
<head>
    ...
    <title>
        @yield('title', 'Rider Dashboard') | SARI
    </title>
    ...
    <style>
        ...
        body.courier-sidebar-collapsed
        ...
        body.courier-sidebar-collapsed
        #courierSidebarLogo img {
            width: 52px;
        }

        body.courier-sidebar-collapsed
        #courierSidebarProfile > a {
            justify-content: center;
            padding: 10px;
        }
...
<body class="min-h-screen bg-[#fbfaf7] antialiased">
    ...
    >
        ...
        >
            ...
            <a
                ...
                aria-label="SARI Rider Dashboard"
            >
                <img
        ...
        >
            ...
            >
                ...
                @if (($stats['available_requests'] ?? 0) > 0)
        ...
        >
            ...
            >
                ...
                {{-- Keep original SARI rider accent --}}
                <div
                    class="
                        grid h-11 w-11
                        shrink-0
    ...
    <div
        id="courierMain"
        class="min-h-screen lg:pl-[275px]"
    >
            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        type="button"
                        aria-label="Collapse rider sidebar"
                        aria-expanded="true"
                        class="
                            hidden h-11 w-11
                            shrink-0
                ...
                >
                    ...
                    >
                        ...
                        <input
                            ...
                            aria-label="Search deliveries and orders"
                            class="
                                h-11
                                w-[220px]
                                rounded-[14px]
    ...
    <div
        ...
        class="
            ...
            bg-[#fffdf8]
            p-4
            shadow-[0_18px_55px_rgba(66,52,25,.15)]
            sm:right-6
        "
    >
    ...
    <script>
        (() => {
            ...
            window.SariCourierToast = (
                ...
                clearTimeout(
                    window.__sariCourierToastTimer
                );
            ...
            document.addEventListener(
                ...
                () => {
                    window.SariCourierToast?.(
                        @json(
                            session(
                                'courier_success_title'
                            )
                        ),

                        @json(
                            session(
                                'courier_success_message'
                            )
                        )
                    );
                }
